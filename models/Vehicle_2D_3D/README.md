...
- ### Onshape Model Draft -Onshape 模型草圖
  ...
  - #### Design and production of 3D/2D models for vehicle parts  -車輛零件的 3D/2D 模型設計與製作
    ...
    <td align="center"><img src="./Vehicle_Chassis_Sizse/img/vehicle_Underfloor.png" height="150"  alt="vehicle Underfloor"></td> 
    <td align="center"><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Mid_deck.png" height="150" alt="Vehicle_Mid_deck"></td> 
    <td align="center"><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Top_Deck.png" height="150" alt="Vehicle_Top_Deck"></td> 
    </tr>
    </table>
    </div> 
     <div align=center>
  ...
  - #### Vehicle Chassis Panels Dimensions Chart -車輛底盤板件尺寸圖表
    ...
    <td><img src="./Vehicle_Chassis_Sizse/img/2D_bottom.jpg" width="300" alt=" 2D_bottom"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/2D_mid.jpg" width="300" alt=" 2D_mid"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/2D_top.jpg" width="300" alt=" 2D_top"></td>
    </tr>
    </table>
    </div> 
  ...
  - #### Vehicle Body Wooden Panels Produced Using a Laser Cutting Machine -使用雷射切割機製作的車身木質板件
     ...
     <tr>
     <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle Underfloor.jpg" width="200" alt="Vehicle Underfloor"></td>
     <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Mid-Deck.jpg" width="200" alt="Vehicle Mid-Deck"></td>
     <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Top_Deck.jpg" width="200" alt="Vehicle Top Deck"></td>
     </tr>
     </table>
     </div>
