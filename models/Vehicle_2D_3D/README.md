...
- ### Onshape Model Draft (Onshape 模型草圖)
  ...
  - #### Design and production of 3D/2D models for vehicle parts    
    ...
    <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_cad.png" width="600" height="100"alt="Vehicle_cad"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/vehicle_Underfloor.png" width="600" height="100" alt="vehicle Underfloor"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Mid_deck.png" width="600" height="100"alt="Vehicle_Mid_deck"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Top_Deck.png" width="600" height="100"alt="Vehicle_Top_Deck"></td>
    </tr>
    </table>
    </div> 
     <div align=center>
  ...
  - ####  Operation of Laser-Cutting Machine
    <div align="center"><img src="./img/2D.JPEG " width="400" alt="car_board"></div>
