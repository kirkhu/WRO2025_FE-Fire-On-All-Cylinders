...
- ### Onshape Model Draft -Onshape 模型草圖
  ...
  - #### Design and production of 3D/2D models for vehicle parts  -車輛零件的 3D/2D 模型設計與製作
    ...
    <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_cad.png" width="100" alt="Vehicle_cad"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/vehicle_Underfloor.png" width="100"  alt="vehicle Underfloor"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Mid_deck.png" width="100" alt="Vehicle_Mid_deck"></td> 
    <td><img src="./Vehicle_Chassis_Sizse/img/Vehicle_Top_Deck.png" width="100" alt="Vehicle_Top_Deck"></td>
    </tr>
    </table>
    </div> 
     <div align=center>
